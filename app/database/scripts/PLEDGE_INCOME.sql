...
-- --------------------------------------------------------------
select t1.PLEDGEID,t2.CREATED,t2.STARTDATE
  ,t1.DATEOFPAYMENT
  ,t1.SOURCETYPE
  ,t1.ACTUAL_SCOURCE1
  ,[DEFUALT_SCOURCE1] = IIF(t1.ACTUAL_SCOURCE1=t2.FIRST_SOURCECODE1, NULL, t2.FIRST_SOURCECODE1)
  ,t1.ACTUAL_TOTAL
  ,t2.CAMPAIGNCODE,t2.RECRUITMETHOD
  ,t2.SPONSORSHIP1,t2.SPONSORSHIP2
from
