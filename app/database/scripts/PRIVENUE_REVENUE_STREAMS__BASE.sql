...
,cte_sankey_attributes AS (
  SELECT
    ...
    , S1.PLATFORM
    , S1.TQTYPE
    , IIF(RTRIM(ISNULL(S1.CAMPAIGN,'')) = '' OR UPPER(LTRIM(S1.CAMPAIGN)) = 'TLMA', @UNSOLICITED, S1.CAMPAIGN) AS [CAMPAIGNCODE]
...
--     , B1.SOURCECODE AS [SRC1]
  ...
  GROUP BY
    S1.SOLICIT, S1.PLATFORM, S1.TQTYPE, S1.ACCOUNT, S1.CAMPAIGN
    , B1.DESTINATIONCODE
    , B1.DESTINATIONCODE2
--     , B1.SOURCECODE
    , B1.SOURCECODE2
