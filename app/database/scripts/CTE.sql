...
--   , DATEDIFF(d, B2.DATEOFBIRTH, CURRENT_TIMESTAMP )/365 AS [AGE]
  ...
  ELSE -- Not Sponsorship Source Code
    ...
    ELSE
      ...
      THEN
        FIRST_VALUE(S1.ADDITIONALCODE3) OVER(PARTITION BY CONCAT(CONVERT(VARCHAR(10), B2.DATEOFPAYMENT, 112), B2.SERIALNUMBER, B2.ADMITNAME, B2.RECEIPTNO) ORDER BY CASE WHEN S1.SOURCETYPE = 'Merchandise Postage' THEN -1 ELSE 0 END DESC)
      ELSE S1.ADDITIONALCODE3
      END
    END
