...
, cte_legit_pledge as (
  SELECT P1.PLEDGEID
    ...
    ,[CLOSED] = CASE WHEN P1.PLEDGEPLAN NOT LIKE '%Continuous%' THEN P1.ENDDATE ELSE NULL END
    ,[FINISHED] = CASE WHEN P1.PLEDGEPLAN NOT LIKE '%Continuous%' THEN P1.NEXTCALLDATE ELSE NULL END

    ,[CLOSED_FY] =
        CASE WHEN P1.PLEDGEPLAN NOT LIKE '%Continuous%'
