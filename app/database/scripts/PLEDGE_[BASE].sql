...
, cte_legit_pledge as (
  SELECT P1.PLEDGEID
    ...
    , P1.WRITTENDOWN
    , [WRITTENDOWNBY] = CASE WHEN RTRIM(P1.WRITTENDOWNBY) = '' THEN NULL ELSE P1.WRITTENDOWNBY END
    , [WRITTENDOWNREASON] = CASE WHEN RTRIM(P1.WRITTENDOWNREASON) = '' THEN NULL ELSE P1.WRITTENDOWNREASON END
    , P1.ONHOLDDATETIME
    , [ONHOLDBY] = CASE WHEN RTRIM(P1.ONHOLDBY) = '' THEN NULL ELSE P1.ONHOLDBY END
    , [ONHOLDREASON] = CASE WHEN RTRIM(P1.ONHOLDREASON) = '' THEN NULL ELSE P1.ONHOLDREASON END

    , [CLOSED] = CASE WHEN P1.PLEDGEPLAN LIKE '%Continuous%' THEN P1.ENDDATE ELSE NULL END
    , [FINISHED] = CASE WHEN P1.PLEDGEPLAN LIKE '%Continuous%' THEN P1.NEXTCALLDATE ELSE NULL END

    , [CLOSED_FY] =
        CASE WHEN P1.PLEDGEPLAN LIKE '%Continuous%'
