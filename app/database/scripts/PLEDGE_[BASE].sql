...
, cte_legit_pledge as (
  SELECT P1.PLEDGEID
    ...
    , [CLOSED] = P1.NEXTCALLDATE
    , [FINISHED] = P1.ENDDATE
    , [FINISHED_FY] = YEAR(P1.ENDDATE) + CASE WHEN MONTH(P1.ENDDATE) < 7 THEN 0 ELSE 1 END
    , [CLOSED_FY] = YEAR(P1.NEXTCALLDATE) + CASE WHEN MONTH(P1.NEXTCALLDATE) < 7 THEN 0 ELSE 1 END
