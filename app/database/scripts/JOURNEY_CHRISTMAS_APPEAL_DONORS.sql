DECLARE
  @CAMPAIGNCODE1 VARCHAR (30) = /*<CAMPAIGN_CODE1>*/'%19DV.Christmas Appeal%'/*</CAMPAIGN_CODE1>*/,
  ...
  @SOURCECODE2 VARCHAR (30) = /*<CAMPAIGN_CODE2>*/'19DEC2A'/*</CAMPAIGN_CODE2>*/,
  @SOURCECODE3 VARCHAR (30) = /*<CAMPAIGN_CODE2>*/'19DEC3A'/*</CAMPAIGN_CODE2>*/
  ;
-- --------------------------------------------------------------
;WITH
cte_payments as (
  SELECT
    ...
    , CASE WHEN S1.ADDITIONALCODE3 LIKE @CAMPAIGNCODE1 OR S1.ADDITIONALCODE3 LIKE @CAMPAIGNCODE2 OR B1.SOURCECODE = @SOURCECODE1 OR B1.SOURCECODE = @SOURCECODE2 OR B1.SOURCECODE = @SOURCECODE3
      THEN -1
      ELSE 0
      END AS [IS_CAMPAIGN]
  FROM
...
,cte_target_contacts as (
  ...
  WHERE
    ...
    AND (
      ...
      OR TBL_SOURCECODE.ADDITIONALCODE3 LIKE @CAMPAIGNCODE2
      OR TBL_BATCHITEMSPLIT.SOURCECODE = @SOURCECODE1
      OR TBL_BATCHITEMSPLIT.SOURCECODE = @SOURCECODE2
      OR TBL_BATCHITEMSPLIT.SOURCECODE = @SOURCECODE3
    )
