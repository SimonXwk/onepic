...
--   ,[FULLNAME] = MIN(t2.PAYMENT_FULLNAME)
  ...
  ,[FIRST_CAMPAIGN] = MIN(CASE WHEN t2.DATEOFPAYMENT = t1.FIRSTDATE AND t2.CAMPAIGNCODE NOT LIKE '%Post%' AND t2.CAMPAIGNCODE NOT LIKE '%Aux%' THEN t2.CAMPAIGNCODE ELSE NULL END)
